...
cell_dim = Supercell(cif_path, lattice_vector, path_supercell)
...
path = ShortestPath(most_connected_node, start, vertex_table, edge_table)
...
np.savetxt(os.path.join(path, fname + pagerank_fname), path[0], fmt='%.3f', newline=" ")
